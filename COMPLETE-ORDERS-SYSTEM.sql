...
-- ==========================================
-- You now have:
-- - 5 tables: user_transactions, orders, order_status_history, shipping_rates, parcel_lockers
-- - 17 shipping rates (Omniva LV/LT/EE, DPD LV, Latvijas Pasts LV)
-- - 77 parcel lockers across Latvia (45), Lithuania (16), Estonia (16)
-- - Full RLS policies (buyer/seller/admin access)
-- - 5 DB triggers (updated_at ×3, order number, status history)
-- - 5 RPC functions (create order, process payment, release escrow, refund, shipping quote)
-- - Meetup: funds held in escrow until both parties confirm
